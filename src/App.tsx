        ...
        <div className="bg-[#0a0a0f] border border-gray-800 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="p-3 bg-black rounded border border-gray-900">
              <span className="text-[10px] text-gray-500 uppercase block mb-1">Source Données</span>
              <Tooltip text="Fichier XML contenant les données du CV : nom, titre, email, expériences, compétences, etc.">
                <span className="text-xs code-font text-purple-400 cursor-help">cv.xml</span>
              </Tooltip>
            </div>
            <div className="p-3 bg-black rounded border border-gray-900">
              <span className="text-[10px] text-gray-500 uppercase block mb-1">Feuille de Style</span>
              <Tooltip text="Fichier XSLT qui définit comment présenter les données du CV : mise en page, couleurs, sections, formatting.">
                <span className="text-xs code-font text-cyan-400 cursor-help">cv.xslt</span>
              </Tooltip>
            </div>
            <button onClick={generate} className="neon-btn-primary w-full mt-4">GÉNÉRER CV HUB</button>
            {xml && (
                            <Tooltip text="Exporte les données brutes du CV en fichier XML. Utile pour l'intégration dans d'autres systèmes ou archives.">
                              <button 
